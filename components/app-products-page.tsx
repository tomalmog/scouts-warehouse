...
const initialProducts: Product[] = [
  ...
  { id: 3, name: 'Doohickey C', stock: 20, description: 'A versatile doohickey' },
  { id: 4, name: 'Thingamajig D', stock: 40, description: 'A robust thingamajig' },
  { id: 5, name: 'Whatchamacallit E', stock: 25, description: 'An efficient whatchamacallit' },
    ...
    columnHelper.accessor('id', {
      ...
      cell: info => (
        <Input
          ...
          onChange={e => {
            const value = Math.min(Number(e.target.value), info.row.original.stock)
    ...
    columnHelper.accessor('id', {
      ...
      cell: info => (
        <Button
          ...
          disabled={!quantities[info.getValue()] || quantities[info.getValue()] === 0}
        >
          Add to Checkout
        </Button>
      ),
